	...
	stage('E-mail Approval') {
        ...
        stage ('deploy') {
            steps {   
                ...
                deploy adapters: [tomcat9(credentialsId: '10', path: '', url: 'http://3.88.104.235:9090/')], contextPath: 'DEV', war: '/var/lib/jenkins/workspace/First Pipeline/maven-project-${GIT_COMMIT}.war'
            }
        }
    }
}
